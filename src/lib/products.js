...
export const SACKS = [
  {
    ...
    sub: 'GLOW IN THE DARK · UV REACTIVE',
    image: '/img/products/magical-sack.webp',
    desc: 'The Magical Sack is a suede foot bag in deep purple with green star points. It glows in the dark and lights up under UV, so the circle does not have to break when the sun goes down.',
    price: 18,
    compareAt: 22,
    preorder: false,
